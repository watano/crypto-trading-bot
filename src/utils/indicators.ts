...
function zigzag(ticks: Candle[], deviation = 5, arraySize = -1): ZigZagPoint[] {
  ...
  for (let i = startingTick; i < ticks.length; ++i) {
    const close = parseFloat(String(ticks[i].close));
    const high = parseFloat(String(ticks[i].high));
    const low = parseFloat(String(ticks[i].low));
  ...
  for (let i = 0; i < turningPoints.length; ++i) {
    ...
    result.push({
      ...
      value: tp.value,
      deviation: parseFloat((tp.deviation * 100).toFixed(2)),
      turningPoint: tp.deviation > deviation || tp.deviation < -deviation
    });
...
function executeTulindIndicator(
  source: NumericSeries | Candle[],
  indicator: IndicatorDescriptor,
  tulindOptions: TulindExecOptions
  ...
  return new Promise(resolve => {
    ...
    const mappedSources: any[] =
      sources && sources.length > 0
        ? sources.map(s => (source as Candle[]).map(ss => Number((ss as any)[s])))
        : [source];
    ...
    const result = bands
      .filter((b: any): b is { lower: number; middle: number; upper: number } => b !== null)
      .map((b: any) => {
...
const indicators = {
  ...
  obv: (source: Candle[], indicator: IndicatorDescriptor) =>
    executeTulindIndicator(source, indicator, { sources: ['close', 'volume'] }),
  ao: (source: Candle[], indicator: IndicatorDescriptor) =>
    executeTulindIndicator(source, indicator, { sources: ['high', 'low'] }),
  wma: (source: NumericSeries, indicator: IndicatorDescriptor) =>
    executeTulindIndicator(source, indicator, { options: { length: 9 } }),
  dema: (source: NumericSeries, indicator: IndicatorDescriptor) =>
    executeTulindIndicator(source, indicator, { options: { length: 9 } }),
  tema: (source: NumericSeries, indicator: IndicatorDescriptor) =>
    executeTulindIndicator(source, indicator, { options: { length: 9 } }),
  trima: (source: NumericSeries, indicator: IndicatorDescriptor) =>
    executeTulindIndicator(source, indicator, { options: { length: 9 } }),
  kama: (source: NumericSeries, indicator: IndicatorDescriptor) =>
    executeTulindIndicator(source, indicator, { options: { length: 9 } }),

  roc: (source: NumericSeries, indicator: IndicatorDescriptor) =>
  ...
  atr: (source: Candle[], indicator: IndicatorDescriptor) =>
    executeTulindIndicator(source, indicator, {
  ...
  mfi: (source: Candle[], indicator: IndicatorDescriptor) =>
    executeTulindIndicator(source, indicator, {
  ...
  sma: (source: NumericSeries, indicator: IndicatorDescriptor) =>
    executeTulindIndicator(source, indicator, {
      options: {
        length: indicator?.options?.length ?? 14
      }
  ...
  ema: (source: NumericSeries, indicator: IndicatorDescriptor) =>
    executeTulindIndicator(source, indicator, {
      options: {
        length: indicator?.options?.length ?? 14
      }
  ...
  rsi: (source: NumericSeries, indicator: IndicatorDescriptor) =>
    executeTulindIndicator(source, indicator, {
      options: {
        length: indicator?.options?.length ?? 14
      }
  ...
  cci: (source: Candle[], indicator: IndicatorDescriptor) =>
    executeTulindIndicator(source, indicator, {
      sources: ['high', 'low', 'close'],
      options: {
  ...
  vwma: (source: Candle[], indicator: IndicatorDescriptor) =>
    executeTulindIndicator(source, indicator, {
  ...
  stoch: (source: Candle[], indicator: IndicatorDescriptor) =>
    executeTulindIndicator(source, indicator, {
      sources: ['high', 'low', 'close'],
  ...
  adx: (source: Candle[], indicator: IndicatorDescriptor) =>
    executeTulindIndicator(source, indicator, {
      sources: ['high', 'low', 'close'],
      options: { length: 14 }
    }),

  stoch_rsi: function (source: NumericSeries, indicator: IndicatorDescriptor): Promise<Record<string, any>> {
    return new Promise(resolve => {
  ...
  psar: function (source: Candle[], indicator: IndicatorDescriptor): Promise<Record<string, any>> {
    return new Promise(resolve => {
      const { options = {} } = indicator as { options: any };
  ...
  heikin_ashi: function (source: Candle[], indicator: IndicatorDescriptor): Promise<Record<string, any>> {
    return new Promise(resolve => {
  ...
  volume_profile: function (source: Candle[], indicator: IndicatorDescriptor): Promise<Record<string, any>> {
    return new Promise(resolve => {
      const { options = {} } = indicator as { options: any };
  ...
  volume_by_price: function (source: Candle[], indicator: IndicatorDescriptor): Promise<Record<string, any>> {
    return new Promise(resolve => {
      const { options = {} } = indicator as { options: any };
      ...
      const minMax = lookbackRange.reduce<[number, number]>(
        (accumulator, currentValue) => [
          Math.min(Number(currentValue.close), accumulator[0]),
          Math.max(Number(currentValue.close), accumulator[1])
        ],
      ...
      for (let i = 0; i < ranges; i++) {
        const map = lookbackRange
          .filter(c => Number(c.close) >= current && Number(c.close) < current + rangeSize)
          .map(c => Number(c.volume));

        rangeBlocks.push({
          low: i === 0 ? current * 0.9999 : current,
          high: i === ranges - 1 ? minMax[1] * 1.0001 : current + rangeSize,
          volume: map.length > 0 ? map.reduce((x, y) => x + y, 0) : 0
        });
  ...
  zigzag: function (source: Candle[], indicator: IndicatorDescriptor): Promise<Record<string, any>> {
    return new Promise(resolve => {
      const { options = {} } = indicator as { options: any };
  ...
  ichimoku_cloud: function (source: Candle[], indicator: IndicatorDescriptor): Promise<Record<string, any>> {
    return new Promise(resolve => {
      const { options = {} } = indicator as { options: any };
  ...
  pivot_points_high_low: function (source: Candle[], indicator: IndicatorDescriptor): Promise<Record<string, any>> {
  ...
  wicked: function (source: Candle[], indicator: IndicatorDescriptor): Promise<Record<string, any>> {
    const { key } = indicator;
    return new Promise(resolve => {
  ...
  candles: async (source: Candle[], indicator: IndicatorDescriptor) => ({
